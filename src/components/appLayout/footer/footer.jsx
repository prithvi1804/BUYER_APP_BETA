...
import CallIcon from "../../../assets/icons/fontawesome/solid/phone.svg?react";
import WhatsappIcon from "../../../assets/icons/fontawesome/brands/whatsapp.svg?react";
...
const Footer = () => {
    ...
    const updateQueryParams = (catName) => {
        if(locationData.search === "" && query.get("c") === null){
            navigate(`/application/products?c=${catName}`)
        }else{
                ...
                <Grid item xs={12} sm={12} md={4} lg={4} xl={4}>
                    ...
                    >
                        ...
                        <div className={classes.contactUsItem}>
                            <div>
                                <WhatsappIcon className={classes.contactUsIcon} />
                            </div>
                        ...
                        <div className={classes.contactUsItem}>
                            <div>
                                <CallIcon className={classes.contactUsIcon} />
                            </div>
                            <div className={classes.itemDetailsContainer}>
